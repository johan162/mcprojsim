...
if [[ ! -f "$EXPECTED_USER_GUIDE_DARK_FILE" ]]; then
...
if [[ "$USER_GUIDE_DARK_SIZE" -lt 1000 ]]; then
    print_error "Dark user guide PDF suspiciously small: $USER_GUIDE_DARK_SIZE bytes"
    exit 1
fi
