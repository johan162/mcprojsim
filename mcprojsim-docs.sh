#!/usr/bin/env bash
# =============================================================================
# mcprojsim-docs.sh - Start/Stop/Manage mcprojsim documentation server
#
# This script manages the documentation container which serves the mcprojsim
# documentation via a web server.
#
# Usage:
#   ./mcprojsim-docs.sh [command] [options]
#
# Commands:
#   start   - Start the documentation server (default)
#   stop    - Stop the documentation server
#   restart - Restart the documentation server
#   status  - Show server status
#   logs    - Show server logs
#   build   - Rebuild the documentation image
#
# Options:
...
#
# Examples:
#   ./mcprojsim-docs.sh                     # Start docs server on port 9090
#   ./mcprojsim-docs.sh start -p 8080       # Start on port 8080
#   ./mcprojsim-docs.sh stop                # Stop the server
#   ./mcprojsim-docs.sh restart -p 9000     # Restart on different port
#   ./mcprojsim-docs.sh logs -f             # Follow logs
#
...
build_image() {
    ...
    local dockerfile="${script_dir}/Dockerfile.docs"
