...
Simulation time: 0.34 seconds
Peak simulation memory: 13.48 MiB
...
Effort Confidence Intervals:
  P25: 643.99 person-hours (81 person-days)
  P50: 684.08 person-hours (86 person-days)
  P75: 728.42 person-hours (92 person-days)
  P80: 738.74 person-hours (93 person-days)
  P85: 751.36 person-hours (94 person-days)
  P90: 767.83 person-hours (96 person-days)
  P95: 789.35 person-hours (99 person-days)
  P99: 833.24 person-hours (105 person-days)
...
Schedule Slack:
  ...
  task_003: 165.18 hours (165.2h buffer)
  task_007: 356.32 hours (356.3h buffer)

Risk Impact Analysis:
  task_001: mean=3.20h, triggers=20.0%, mean_when_triggered=16.00h
  task_003: mean=5.99h, triggers=24.9%, mean_when_triggered=24.00h
  task_004: mean=12.17h, triggers=30.4%, mean_when_triggered=40.00h
  task_006: mean=11.31h, triggers=35.3%, mean_when_triggered=32.00h
  task_008: mean=4.75h, triggers=19.8%, mean_when_triggered=24.00h

Most Frequent Critical Paths:
  1. task_001 -> task_002 -> task_004 -> task_005 -> task_006 -> task_008 (9999/10000, 100.0%)
  2. task_003 -> task_005 -> task_006 -> task_008 (1/10000, 0.0%)

Staffing (based on mean effort): 2 people recommended (mixed team), 73 working days
  Total effort: 686 person-hours (86 person-days) | Parallelism ratio: 1.2
```
